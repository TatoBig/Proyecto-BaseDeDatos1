...
public class inventarioItem extends javax.swing.JInternalFrame {
    ...
    public inventarioItem() {
        ...
        try (Connection cnx = conexion.getConnection()) {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                model.addRow(new Object[]{rs.getInt("producto.id"), rs.getString("producto.Nombre"), rs.getInt("producto.Costo"), rs.getInt("producto.Precio_Venta"), rs.getInt("producto.Cantidad"), rs.getString("categor�a.Tipo")});
            }
        } catch (Exception e) {
